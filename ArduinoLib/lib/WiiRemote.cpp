...
void HCIProto::init(void) {
    Max.powerOn();
    delay(200);
}

void HCIProto::task(void (*pFunc)(void)) {
    Max.Task();
    Usb.Task();
    delay(1);
...
uint8_t HCIProto::getStatus(void) {
    return wiiremote_status_;
}

void HCIProto::setBDAddress(uint8_t *bdaddr, int size) {
...
void HCIProto::setBDAddressMode(eBDAddressMode mode) {
    bdaddr_acquisition_mode_ = mode;
}

void HCIProto::getBDAddress(uint8_t *bdaddr, int size) {
    int array_length = ARRAY_LENGTH(wiiremote_bdaddr_);
...
/************************************************************/
void HCIProto::initBTController(void) {
...
void HCIProto::L2CAP_event_task(void) {
    uint8_t rcode = 0;  // return code
    uint8_t buf[MAX_BUFFER_SIZE] = {0};
...
/* L2CAP Commands                                           */
/************************************************************/
uint8_t HCIProto::l2cap_connect(uint16_t scid, uint16_t psm) {
    uint8_t cmd_buf[8];
...
uint8_t HCIProto::l2cap_configure(uint16_t dcid) {
    uint8_t cmd_buf[12];
...
uint8_t HCIProto::l2cap_config_response(
        uint8_t rxid,
        uint16_t dcid) {
    uint8_t resp_buf[10];
...
uint8_t HCIProto::l2cap_disconnect_response(
        uint8_t rxid,
        uint16_t scid,
        uint16_t dcid) {
    uint8_t resp_buf[8];
...
uint8_t HCIProto::L2CAP_Command(uint8_t *data, uint8_t length) {
    uint8_t buf[MAX_BUFFER_SIZE] = {0};
...
/************************************************************/
void HCIProto::readReport(uint8_t *data) {
...
uint8_t HCIProto::writeReport(uint8_t *data, uint8_t length) {
    uint8_t buf[MAX_BUFFER_SIZE] = {0};
...
void HCIProto::parseCalData(uint8_t *data) {
...
void HCIProto::parseAccel(uint8_t *data) {
...
void HCIProto::parseButtons(uint8_t *data) {
...
/************************************************************/
uint8_t HCIProto::setLED(uint8_t led) {
    uint8_t hid_buf[2];
...
uint8_t HCIProto::setReportMode(uint8_t mode) {
    uint8_t hid_buf[3];
...
uint8_t HCIProto::readData(uint32_t offset, uint16_t size) {
    uint8_t hid_buf[7];
...
/* WiiRemote Command                                        */
/************************************************************/
uint8_t HCIProto::readWiiRemoteCalibration(void) {
    return readData(0x0016, 8);
}

bool HCIProto::buttonPressed(uint16_t button) {
    /* true while a button is pressed */
    return ((hid_buttons_ & button) != 0);
}

bool HCIProto::buttonClicked(uint16_t button) {
...
/* etc                                                      */
/************************************************************/
Point3f_t HCIProto::averagePoint3(Point3i_t *data, uint8_t size) {
